...
class HamlParser {
  ...
  /**
	 ...
	 */
	private $inlineTags = array('a', 'abbr', 'accronym', 'b', 'big', 'cite', 'code', 'dfn', 'em', 'i', 'kbd', 'q', 'samp', 'small', 'span', 'strike', 'strong', 'tt', 'u', 'var','title');
	/**
	 * @var array A list of inline tags.
	 */
	private $headTags = array('link');
	/**
...
/**
	...
	private function isHeadTag($line) {
	  return (in_array($line[self::HAML_TAG], $this->headTags) ||
	  	$line[self::HAML_TOKEN] == self::SELF_CLOSE_TAG);
	}
	...
	private function parseElement($line, $parent) {
		...
		$node->isHeadTag = $this->isHeadTag($line);
